...
const std::map<std::string, std::string> param_types_map = {
    ...
    {"max_file_contents_capacity", "unsigned long int"},
    {"max_filename_capacity", "unsigned long int"}
};
...
void parse_ul(toml_parser::config_t& config, param_str_d_t param_str_d) {
    ...
    } else if (param_str_d.name == "max_file_contents_capacity") {
        config.max_file_contents_capacity = value;
    } else if (param_str_d.name == "max_filename_capacity") {
        config.max_filename_capacity = value;
    }
}
