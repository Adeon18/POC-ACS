...
const std::map<std::string, std::string> param_types_map = {
    ...
    {"raw_files_queue_size", "unsigned long int"},
    {"filenames_queue_max_size", "unsigned long int"}
};
...
void parse_ul(toml_parser::config_t& config, param_str_d_t param_str_d) {
    ...
    if (param_str_d.name == "filenames_queue_max_size") {
        config.filenames_queue_max_size = value;
    } else if (param_str_d.name == "raw_files_queue_size") {
        config.raw_files_queue_size = value;
    } else if (param_str_d.name == "indexing_threads") {
