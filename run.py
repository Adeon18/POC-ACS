...
PROGRAM_PATH = os.path.join("bin", "word_indexer")
...
if __name__ == "__main__":
    ...
    if not os.path.isfile(PROGRAM_PATH) and platform.system() != "Windows":
    ...
    print(f"Finding={min_output_time[1]}")
    print(f"Writing={min_output_time[2]}")
